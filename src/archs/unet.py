...
def get_unet(img_rows, img_cols, num_layers = 4, filter_size=3, optimizer = Adam(lr=1e-4),
    ...
    for i in range(num_layers-1, 0, -1):
        ...
        conv = Conv2D(32*2**i, (filter_size, filter_size), activation='relu', padding='same')(up)
        last_in = Conv2D(32*2**i, (filter_size, filter_size), activation='relu', padding='same')(conv)
